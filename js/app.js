...
heroButton.addEventListener('submit', function(event) {
  ...
  document.getElementById('characterName').style.boxShadow = "0 1px 3px rgba(0,0,0,0.12), 0 1px 2px rgba(0,0,0,0.24)";
  ...
  document.getElementById('characterSheet').style.boxShadow = "0 1px 3px rgba(0,0,0,0.12), 0 1px 2px rgba(0,0,0,0.24)";
  ...
  document.getElementById('characterInv').style.boxShadow = "0 1px 3px rgba(0,0,0,0.12), 0 1px 2px rgba(0,0,0,0.24)";
